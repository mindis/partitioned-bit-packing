...
bool run_vector_tests() {
    ...
    ok &= dynamic_vector_test("Partitioned Template <BPV>", new PartitionedVectorTemplate<BasicBitPackedVector>(5));
    ...
    ok &= dynamic_vector_test("Partitioned Tempalte <SIMD-Vector>", new PartitionedVectorTemplate<BitPackedVectorSIMD>(5));
#endif
